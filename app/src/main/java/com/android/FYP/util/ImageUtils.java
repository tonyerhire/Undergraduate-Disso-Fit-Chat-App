...
public class ImageUtils {
    ...
    /**
     *For rectangular pictures, cut the image into a square and take the center part
       Photos for when making avatar will not be distorted
     * @param srcBmp
     * @return
     */
     ...
     * @param reqWidth width size after reduction
     * @param reqHeight height size after reduction
     * @return
     */
