...
import com.android.FYP.activities.MainActivity2;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;
import com.android.FYP.data.StaticConfig;
import com.android.FYP.service.ServiceUtils;
import com.android.FYP.ui.FriendsFragment;
import com.android.FYP.ui.GroupFragment;
import com.android.FYP.ui.LoginActivity;
import com.android.FYP.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private FloatingActionButton fitButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("FitX$Chat");
        }

        viewPager = (ViewPager) findViewById(R.id.viewpager);
        floatButton = (FloatingActionButton) findViewById(R.id.fab);
        fitButton = (FloatingActionButton) findViewById(R.id.fit);
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Stay Fit while chatting!!", Toast.LENGTH_LONG).show();
            return true;
        }
